 ...
 * @Description:
 */
public class ThreadHookSrcHelp {
    private static final String TAG = "ThreadHookSrcHelp";
    ...
    public static void monitorThreadCreate() {
        try {
            DexposedBridge.hookAllConstructors(Thread.class, new XC_MethodHook() {
                ...
                protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                    ...
                    if (clazz != Thread.class) {
                        ...
                        DexposedBridge.findAndHookMethod(clazz, "run", new ThreadHookSrcMethod());
                    }
            ...
            DexposedBridge.findAndHookMethod(Thread.class, "run", new ThreadHookSrcMethod());
        } catch (Exception e) {
            e.printStackTrace();
